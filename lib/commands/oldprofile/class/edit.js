...
class Edit extends command_1.SfdxCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const filesModified = yield edit_1.editInProfiles(util_1.getFileNames(profiles), name, rename, enabled, '', 'class', alphabetize);
            this.ux.stopSpinner('Done');
            this.ux.styledHeader('Classes edited in profiles');
            this.ux.table(util_1.getDataForDisplay(filesModified, 'edit', 'class'), ['Action', 'MetadataType', 'ProjectFile']);
            return {};
        });
    }
}
