...
class Delete extends command_1.SfdxCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const filesModified = yield (0, delete_1.removeFromProfiles)((0, util_1.getFileNames)(profiles), names, 'class', alphabetize);
            this.ux.stopSpinner('Done');
            this.ux.styledHeader('Classes removed from profiles');
            this.ux.table((0, util_1.getDataForDisplay)(filesModified, 'delete', 'class'), ['Action', 'MetadataType', 'ProjectFile']);
            return {};
        });
    }
}
