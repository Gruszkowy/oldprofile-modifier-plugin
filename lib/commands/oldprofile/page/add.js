...
class Add extends command_1.SfdxCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const filesModified = yield (0, add_1.addToProfiles)((0, util_1.getFileNames)(profiles), names, enabled, '', 'page', alphabetize);
            this.ux.stopSpinner('Done');
            this.ux.styledHeader('Pages added to profiles');
            this.ux.table((0, util_1.getDataForDisplay)(filesModified, 'add', 'page'), ['Action', 'MetadataType', 'ProjectFile']);
            return {};
        });
    }
}
