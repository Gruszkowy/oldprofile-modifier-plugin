...
class Edit extends command_1.SfdxCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const filesModified = yield (0, edit_1.editInProfiles)((0, util_1.getFileNames)(profiles), name, rename, false, permissions, 'object', alphabetize);
            this.ux.stopSpinner('Done');
            this.ux.styledHeader('Objects edited in profiles');
            this.ux.table((0, util_1.getDataForDisplay)(filesModified, 'edit', 'object'), ['Action', 'MetadataType', 'ProjectFile']);
            return {};
        });
    }
}
