...
class Add extends command_1.SfdxCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const fileNames = (0, util_1.getFileNames)(profiles);
            const filesModified = yield (0, add_1.addToProfiles)(fileNames, names, false, permissions, 'object', alphabetize);
            if (!addfields) {
                this.ux.stopSpinner('Done');
                this.ux.styledHeader('Objects added to profiles');
                this.ux.table((0, util_1.getDataForDisplay)(filesModified, 'add', 'object'), ['Action', 'MetadataType', 'ProjectFile']);
            }
            else {
                ...
                const fieldNames = yield (0, util_1.getObjectFieldFileNames)(objectsToValidate);
                const filesModified = yield (0, add_1.addToProfiles)((0, util_1.getFileNames)(profiles), fieldNames, false, permissions, 'field', alphabetize);
                this.ux.stopSpinner('Done');
