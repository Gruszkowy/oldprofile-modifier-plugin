...
class Delete extends command_1.SfdxCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const filesModified = yield delete_1.removeFromProfiles(util_1.getFileNames(profiles), names, 'object', alphabetize);
            this.ux.stopSpinner('Done');
            this.ux.styledHeader('Objects removed from profiles');
            this.ux.table(util_1.getDataForDisplay(filesModified, 'delete', 'object'), ['Action', 'MetadataType', 'ProjectFile']);
            return {};
        });
    }
}
