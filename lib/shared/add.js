                ...
                case 'class':
                    ...
                    for (const name of names) {
                        ...
                        if (!existingClass) {
                            ...
                            let classesToSort = [...classes];
                            classesToSort.push(newClass);
                            classesToSort.sort((a, b) => (a['apexClass'] > b['apexClass']) ? 1 : -1);
                            const previousItem = classesToSort[classesToSort.findIndex(x => x['apexClass'] === name) - 1].apexClass;
                ...
                case 'field':
                    ...
                    for (const name of names) {
                        ...
                        if (!existingField) {
                            ...
                            let fieldsToSort = [...fields];
                            fieldsToSort.push(newField);
                            fieldsToSort.sort((a, b) => (a['field'] > b['field']) ? 1 : -1);
                            const previousItem = fieldsToSort[fieldsToSort.findIndex(x => x['field'] === name) - 1].field;
                ...
                case 'object':
                    ...
                    for (const name of names) {
                        ...
                        if (!existingObject) {
                            ...
                            let objectsToSort = [...objects];
                            objectsToSort.push(newObject);
                            objectsToSort.sort((a, b) => (a['object'] > b['object']) ? 1 : -1);
                            const previousItem = objectsToSort[objectsToSort.findIndex(x => x['object'] === name) - 1].object;
                ...
                case 'page':
                    ...
                    for (const name of names) {
                        ...
                        if (!existingPage) {
                            ...
                            const previousItem = pagesToSort[pagesToSort.findIndex(x => x['apexPage'] === name) - 1].apexPage;
